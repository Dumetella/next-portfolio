...
export const GlobalStyle = createGlobalStyle`
    ...
    *:after {
    ...
    :focus {
        outline: 2px dashed ${({ theme }) => theme.colors.accent};
        outline-offset: 3px;
    }
    /*
    ...
    */
    ...
    html {
        ...
        scrollbar-color: ${({ theme }) => theme.colors.textDark} ${({ theme }) => theme.colors.backgroundNormal};
    }
    ...
    body::-webkit-scrollbar-thumb {
        ...
        border: 3px solid ${({ theme }) => theme.colors.backgroundNormal};
        border-radius: 10px;
    }
    body {
        margin: 0;
