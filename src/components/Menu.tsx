...
const Menu = () => {
    ...
    const handleBackwardTab = (e: React.SyntheticEvent) => {
    ...
    const handleForwardTab = (e: React.SyntheticEvent) => {
    ...
    const onResize = (e: React.SyntheticEvent) => {
...
interface StyledHamburgerButtonProps extends DefaultStyledComponent {
    menuOpen: boolean;
}
