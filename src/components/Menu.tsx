...
interface StyledHamburgetButtonProp extends DefaultStyledComponent {
  menuOpen: boolean;
}

const StyledHamburgerButton = styled.button<StyledHamburgetButtonProp>`
  display: none;
...
interface StyledSidebarProps extends DefaultStyledComponent {
  menuOpen: boolean;
}
...
const StyledSidebar = styled.aside<StyledSidebarProps>`
  ...
  @media (max-width: 768px) {
    ...
    box-shadow: -10px 0px 30px -15px ${({ theme }) => theme.colors.backgroundDark};;
    z-index: 9;
